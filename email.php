          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                ...
                PetBest Service Update
              </a>
              </td>
            </tr>
            <!-- Email Body -->
            <?php if (isset($_SESSION['orderInfo'])) {
              $userInfo = $_SESSION['orderInfo'];
            }?>
            <tr>
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hi ,</h1>
                        <p>Thanks for Choosing PetBest. This is an invoice for your recent purchase.</p>
              ...
              <strong>Amount Due:</strong> <?php $_SESSION['orderInfo']; ?>
            </span>
                                  </td>
                                </tr>
                                <tr>
